 ...
 * @author MINH TUNG
 */
public class FormCTHDX extends javax.swing.JFrame {
    ...
    try {
        ...
        String sql = "SELECT HOADONXUAT.MaHDX, HOADONXUAT.MaKh, HOADONXUAT.MaNv, HOADONXUAT.NgayLap, " +
                     ...
                     "CHITIETHDX.MaHang, HANGHOA.TenHang AS TenSanPham, HANGHOA.DonGia, CHITIETHDX.SoLuong, HOADONXUAT.TongTien " +
                     "FROM HOADONXUAT " +
...
private void loadtableCTHD2() {
    try {
        Connection conn = DatabaseConnection.getConnection(); // Lấy kết nối đến cơ sở dữ liệu
        String sql = "SELECT HOADONXUAT.MaHDX AS MaHD, CHITIETHDX.MaHang, HANGHOA.TenHang AS TenSanPham, HOADONXUAT.NgayLap, " +
                     "HANGHOA.DonGia, CHITIETHDX.SoLuong, HOADONXUAT.TongTien " +
                     "FROM HOADONXUAT " +
                     "INNER JOIN CHITIETHDX ON HOADONXUAT.MaHDX = CHITIETHDX.MaHDX " +
                     "INNER JOIN HANGHOA ON CHITIETHDX.MaHang = HANGHOA.MaHang";
...
private void loadDataToTableCTHD1(String maKhachHang) {
    try {
        ...
        String sql = "SELECT HOADONXUAT.MaHDX, HOADONXUAT.MaKh, HOADONXUAT.MaNv, HOADONXUAT.NgayLap, " +
                ...
                "INNER JOIN CHITIETHDX ON HOADONXUAT.MaHDX = CHITIETHDX.MaHDX " +
                "INNER JOIN HANGHOA ON CHITIETHDX.MaHang = HANGHOA.MaHang " +
                "INNER JOIN HOADONXUAT ON HOADONXUAT.MaHDX = HOADONXUAT.MaHDX " +
                "INNER JOIN KHACHHANG ON HOADONXUAT.MaKh = KHACHHANG.MaKh " +
                "INNER JOIN NHANVIEN ON HOADONXUAT.MaNv = NHANVIEN.MaNv " +
                "WHERE KHACHHANG.MaKh = ?";
        
        PreparedStatement preparedStatement = conn.prepareStatement(sql);
        preparedStatement.setString(1, maKhachHang); // Thiết lập tham số cho câu lệnh SQL
...
private void loadDataToTableCTHD2(String maKhachHang) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCTHDX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
